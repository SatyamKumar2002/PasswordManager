...
function Manager() {
  ...
  const deletePassword = (id) => {
    ...
    let c = confirm("Do you rally wants to delete the password?")
    if(c){
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <div className="flex flex-col md:flex-row w-full justify-between gap-8">
            ...
            <div className="relative">
              ...
              />
              <span
                className="absolute right-[4px] top-[9px] cursor-pointer"
                  ...
                  {passwordArray.map((item, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td className="justify-center text-center w-80 py-2 border border-white">
